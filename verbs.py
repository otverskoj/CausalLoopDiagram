...
VERBS_INCREASE = np.array((
    ...
    'rise', 'step up', 'strengthen', 'swell', 'triple', 'widen', 'aggrandize',
    'aggravate', 'amplify', 'annex', 'augment', 'dilate', 'distend',
    'exaggerate', 'inflate', 'lengthen', 'magnify', 'mount', 'pad', 'progress',
    'proliferate', 'prolong', 'protract', 'pullulate', 'redouble', 'sharpen',
...
VERBS_DECREASE = np.array((
    ...
    'slash', 'slump', 'soften', 'subside', 'wane', 'weaken', 'check',
    'contract', 'crumble', 'decay', 'degenerate', 'devaluate', 'droop',
    'evaporate', 'fade', 'lighten', 'modify', 'quell', 'quiet', 'restrain',
    'settle', 'shrivel', 'waste', 'wither', 'calm down', 'die down', 'dry up',
